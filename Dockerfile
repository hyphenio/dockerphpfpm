...
RUN apt-get update && apt-get -y dist-upgrade && apt-get -y install php7.0 php7.0-fpm php7.0-curl php7.0-mysql php7.0-mcrypt && apt-get clean && apt-get autoclean && apt-get autoremove
