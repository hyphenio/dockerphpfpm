...
RUN apt-get update && apt-get -y dist-upgrade && apt-get -y install php7.0 php7.0-fpm php7.0-tidy php7.0-xml php7.0-bcmath php7.0-gd php7.0-mbstring php7.0-curl php7.0-mysql php7.0-mcrypt && apt-get clean && apt-get autoclean && apt-get autoremove
